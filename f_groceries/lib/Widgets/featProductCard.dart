...
class FeatProduct_Card extends StatefulWidget {
  final int id;
  var img;
  var name;
  var price;
  ...
  @override
  _featProduct_CardState createState() => _featProduct_CardState();
}

class _featProduct_CardState extends State<FeatProduct_Card> {
...
@override
  void initState() {
    ...
    checkCart();
    checkBookmark();
    discount =((( double.parse(widget.regularPrice) -double.parse(widget.price))/double.parse(widget.regularPrice))*100).round();
  }
    @override
        ...
        checkCart();
            ...
            child: Column(
              ...
              children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                        ...
                        widget.price != widget.regularPrice
                          ...
                          Text(discount.toString()+"% "+"OFF" ,style: TextStyle( color: Colors.white, fontSize: 12)),
                ...
                Padding(padding: EdgeInsets.fromLTRB(10, 5, 7, 5),
...
Container(
                ...
                //       child: Text(inCart?'Added to Cart':'Add'),
