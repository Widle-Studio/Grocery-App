...
class _CategoryProductsState extends State<CategoryProducts> {
  ...
  getProducts() async {
    ...
    var res = await wc_api
        .getAsync("products?status=publish&category=${widget.id}&per_page=100");
    ...
    return Scaffold(
      ...
      actions: <Widget>[
          IconButton(
            ...
            onPressed: () async {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>Search(id: widget.id,name: widget.name,)));
